...
BAD_WORDS = ['сайт', 'вакансия', 'резюме','кеш', 'маркетплейс', 'бухгалтер', 'себестоимость', 'дизайнер', 'опт', 'оптовый', 'продам', 'инфографика', 'выплачен', 'выплаты', 'продам', 'наличии', 'рассылка', 'заработок', 'доход','деньги', 'реклама']
