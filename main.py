...
BAD_WORDS = ['сайт', 'вакансия', 'резюме', 'работа', 'оффлайн', 'листовок', 'карту', 'полного', 'кеш', 'эффективно', 'трафик', 'эффективное', 'эффект', 'пфф', 'продажи', 'эфф', 'коэффиценту', 'инфографику', 'куплю', 'вакансии', 'маркетплейс', 'бухгалтер', 'себестоимость', 'дизайнер', 'опт', 'оптовый', 'продам', 'инфографика', 'выплачен', 'выплаты', 'продам', 'наличии', 'рассылка', 'заработок', 'доход','деньги', 'реклама']
