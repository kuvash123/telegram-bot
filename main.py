...
BAD_WORDS = ['сайт', 'вакансия', 'резюме', 'работа', 'оффлайн', 'листовок', 'кеш', 'вакансии', 'маркетплейс', 'бухгалтер', 'себестоимость', 'дизайнер', 'опт', 'оптовый', 'продам', 'инфографика', 'выплачен', 'выплаты', 'продам', 'наличии', 'рассылка', 'заработок', 'доход','деньги', 'реклама']
