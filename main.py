...
BAD_WORDS = ['сайт', 'вакансия', 'резюме', 'работа', 'оффлайн', 'листовок', 'полного', 'кеш', 'эффективно', 'эффективное', 'продажи', 'эфф', 'коэффиценту', 'инфографику', 'куплю', 'вакансии', 'маркетплейс', 'бухгалтер', 'себестоимость', 'дизайнер', 'опт', 'оптовый', 'продам', 'инфографика', 'выплачен', 'выплаты', 'продам', 'наличии', 'рассылка', 'заработок', 'доход','деньги', 'реклама']
